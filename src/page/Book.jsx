...
export const Book = () => {
  ...
  const data = [
    {
      name: "Durga Pooja",
      description: "Worship of Goddess Durga, symbolizing strength, victory, and the destruction of evil. Celebrated during Navratri.",
      benefits: [
      ...
      aboutPooja: "Durga Puja is a major festival celebrated by Hindus worldwide. It marks the victory of good over evil as depicted in the battle between Durga and the demon Mahishasura.",
      afterPooja: [
    ...
    {
      name: "Gopal Pooja",
      description: "Worship of Lord Krishna in his child form, symbolizing love and playfulness.",
      benefits: [
      ...
      aboutPooja: "Gopal Puja is a popular practice performed by devotees seeking blessings for their children. It can be done daily or on special occasions.",
      afterPooja: [
    ...
    {
      name: "Vastu Pooja",
      description: "Balancing the energies of a space for positive vibes and well-being, following the principles of Vastu Shastra.",
      benefits: [
      ...
      aboutPooja: "Vastu Pooja is performed to address any energy imbalances in a building or property. It's believed to bring peace, prosperity, and good fortune to the occupants.",
      afterPooja: [
    ...
    {
      name: "Chandra Pooja",
      description: "Worship of the Moon God, Chandra, seeking blessings for peace, tranquility, and mental well-being.",
      benefits: [
      ...
      aboutPooja: "Chandra Pooja is particularly beneficial for individuals facing emotional challenges, anxiety, or sleep disturbances. It's often performed on specific days with lunar significance.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship of Goddess Lakshmi, the deity of wealth, prosperity, and fortune.",
      benefits: [
      ...
      aboutPooja: "Mahalaxmi Pooja is performed to seek the blessings of Goddess Lakshmi for wealth, prosperity, and abundance in life. It's often done during Diwali and other auspicious occasions.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship of Lord Shiva in his Mrityunjay form, seeking protection from illness, accidents, and untimely death.",
      benefits: [
      ...
      aboutPooja: "Mrityunjay Pooja is performed to seek the blessings of Lord Shiva for protection from the cycle of birth and death. It's believed to alleviate suffering and grant longevity.",
      afterPooja: [
    ...
    {
      name: "Surya Pooja",
      description: "Worship of the Sun God, Surya, seeking blessings for vitality, health, and prosperity.",
      benefits: [
      ...
      aboutPooja: "Surya Pooja is performed to invoke the blessings of the Sun God for health, vitality, and success. It's believed to promote physical and spiritual well-being.",
      afterPooja: [
    ...
    {
      name: "Saraswati Puja",
      description: "Worship of Goddess Saraswati, the deity of knowledge, wisdom, and arts.",
      benefits: [
      ...
      aboutPooja: "Saraswati Puja is performed to seek the blessings of Goddess Saraswati for knowledge, wisdom, and creativity. It's often observed during the festival of Basant Panchami.",
      afterPooja: [
    ...
    {
      name: "Kali Pooja",
      description: "Worship of Goddess Kali, the fierce form of Shakti, seeking protection and liberation from negative forces.",
      benefits: [
      ...
      aboutPooja: "Kali Pooja is performed to invoke the blessings of Goddess Kali for protection, courage, and spiritual liberation. It's often observed during the festival of Diwali and Navratri.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship and recitation of the Bhagavad Gita, the sacred scripture containing the teachings of Lord Krishna.",
      benefits: [
      ...
      aboutPooja: "Bhagwat Geeta Pooja is performed to honor and seek the blessings of Lord Krishna through the recitation and contemplation of the Bhagavad Gita. It's considered a powerful tool for spiritual growth and self-realization.",
      afterPooja: [
    ...
    {
      name: "Navgrah Pooja",
      description: "Worship of the nine celestial bodies (Navagrahas) for planetary harmony and mitigation of astrological afflictions.",
      benefits: [
      ...
      aboutPooja: "Navgrah Pooja is performed to appease the nine planets and seek their blessings for harmony, prosperity, and protection from astrological influences. It's often recommended for individuals facing challenges due to planetary positions in their horoscope.",
      afterPooja: [
    ...
    {
      name: "Rahu Pooja",
      description: "Worship of Rahu, the shadow planet, to mitigate its malefic effects and seek blessings for spiritual growth.",
      benefits: [
      ...
      aboutPooja: "Rahu Pooja is performed to pacify the malefic effects of Rahu in the birth chart and seek its blessings for spiritual growth and liberation. It's often recommended for individuals experiencing challenges related to Rahu's placement in their horoscope.",
      afterPooja: [
    ...
    {
      name: "Ketu Pooja",
      description: "Worship of Ketu, the shadow planet, to mitigate its malefic effects and seek blessings for spiritual growth.",
      benefits: [
      ...
      aboutPooja: "Ketu Pooja is performed to pacify the malefic effects of Ketu in the birth chart and seek its blessings for spiritual growth and liberation. It's often recommended for individuals experiencing challenges related to Ketu's placement in their horoscope.",
      afterPooja: [
    ...
    {
      name: "Mangal Pooja",
      description: "Worship of Mangal (Mars), the planet of energy, drive, and ambition, to mitigate its malefic effects and seek blessings for strength and vitality.",
      benefits: [
      ...
      aboutPooja: "Mangal Pooja is performed to pacify the malefic effects of Mars in the birth chart and seek its blessings for strength, courage, and success. It's often recommended for individuals experiencing challenges related to Mars's placement in their horoscope.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Elaborate worship of Lord Shiva in his fierce form, Rudra, seeking blessings for spiritual purification, protection, and liberation.",
      benefits: [
      ...
      aboutPooja: "Rudra Abhishek Pooja is performed with utmost devotion and reverence to Lord Shiva to invoke his blessings for spiritual purification, protection, and liberation. It's considered a powerful means of attaining spiritual upliftment and inner peace.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship to strengthen the bond of marriage and foster love, harmony, and understanding between partners.",
      benefits: [
      ...
      aboutPooja: "Gath Bandhan Pooja is performed to strengthen the marital bond and invoke divine blessings for a harmonious and blissful married life. It's often performed on auspicious occasions or as a remedial measure for marital discord.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship of Lord Vishnu in his form as Satya Narayan, the embodiment of truth and righteousness, seeking blessings for prosperity, well-being, and spiritual fulfillment.",
      benefits: [
      ...
      aboutPooja: "Satya Narayan Pooja is performed to seek the blessings of Lord Vishnu and Goddess Lakshmi for prosperity, happiness, and spiritual fulfillment. It's often observed on full moon days or as a special occasion in Hindu households.",
      afterPooja: [
        "Share prasad (blessed offerings) with family and friends.",
    ...
    },
    {
      ...
      description: "Worship of Lord Brihaspati, the deity of wisdom, knowledge, and auspiciousness, seeking blessings for intellect, success, and spiritual growth.",
      benefits: [
      ...
      aboutPooja: "Brihaspati Pooja is performed to seek the blessings of Lord Brihaspati for wisdom, intellect, success, and auspiciousness. It's often observed on Thursdays or as a remedial measure for Jupiter-related afflictions in the horoscope.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Worship performed to appease the ruling deity of a person's birth star (nakshatra) for health, prosperity, and overall well-being.",
      benefits: [
      ...
      aboutPooja: "Nakshatra Pooja is performed to appease the ruling deity of an individual's birth star and seek blessings for health, prosperity, and overall well-being. It's considered auspicious and beneficial to perform this pooja regularly.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Remedial worship performed to alleviate the ancestral curse (pitra dosh) affecting one's lineage and seeking blessings for peace, harmony, and prosperity.",
      benefits: [
      ...
      aboutPooja: "Pitra Dosh Nivaran Pooja is performed to alleviate the ancestral curse (pitra dosh) affecting one's lineage and seek blessings for peace, harmony, and prosperity. It's believed to bring relief from obstacles and sufferings caused by ancestral karma.",
      afterPooja: [
    ...
    },
    {
      ...
      description: "Remedial worship performed to alleviate the malefic effects of Mars (Mangal) in one's horoscope and seeking blessings for marital harmony, happiness, and well-being.",
      benefits: [
      ...
      aboutPooja: "Manglik Dosh Nivaran Pooja is performed to alleviate the malefic effects of Mars (Mangal) in one's horoscope and seek blessings for marital harmony, happiness, and well-being. It's often recommended for individuals facing challenges or delays in marriage due to Mangal dosh.",
      afterPooja: [
  ...
  return (
    ...
    >
      <h1 style={{ marginBottom: "20px", fontWeight:"bold" }}>Booked</h1>
      <h1 style={{fontWeight:"bold"}}>{pooja?.name}</h1>
    </div>
  );
};
